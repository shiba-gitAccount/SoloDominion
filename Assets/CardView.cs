...
public class CardView : MonoBehaviour
{
    ...
    void OnClickCard()
    {
        ...
        else if (GameManager.Instance.currentPhase == GamePhase.Buy)
        {
            if (this.location == CardLocation.Supply)
            {
                currentContext = CardContext.Supply;
            }
            else if (this.location == CardLocation.Hand && this.data.cardtype == CardType.Treasure)
            {
                currentContext = CardContext.Hand;
            }
        }
        ...
        {
            if (this.location == GameManager.Instance.selectLocation)
            {
        ...
        else if (GameManager.Instance.currentPhase == GamePhase.isGaining && this.location == CardLocation.Supply)
        {
